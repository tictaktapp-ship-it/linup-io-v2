// Doc 5 Screen 1 Trust Signals
// "Your IP is protected" / "Your data is isolated" / "You always understand what's happening"
...
const SIGNALS = [
  ...
  { icon: '👁',  heading: 'You always understand what\'s happening', body: 'Named specialists, live progress, and plain-language summaries at every stage. No black box.' },
];
