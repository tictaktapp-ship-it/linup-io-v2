  ...
  return (
    <nav style={{
      ...
      <Link to="/" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center' }}>
        {logoFailed ? (
          <span style={{ fontWeight: 800, fontSize: '22px', letterSpacing: '-0.02em', color: '#8C00B4' }}>LINUP</span>
        ) : (
          <img src="/logo.png" alt="LINUP" style={{ height: '36px', width: 'auto', display: 'block', maxWidth: '160px' }} onError={() => setLogoFailed(true)} />
        )}
      </Link>
