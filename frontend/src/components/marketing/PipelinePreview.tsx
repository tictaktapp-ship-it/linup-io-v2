...
// Doc 5 Screen 1 Pipeline Preview
// Scrollable stage pills, click to expand description
          ...
          return (
            <button
              ...
              style={{
                ...
                padding: '8px 16px',
                borderRadius: '100px',
                border: isActive ? '1px solid #8C00B4' : '1px solid rgba(255,255,255,0.08)',
                background: isActive ? 'rgba(140, 0, 180, 0.15)' : 'transparent',
                color: isActive ? '#C44DFF' : 'var(--color-surface-3)',
                cursor: 'pointer',
