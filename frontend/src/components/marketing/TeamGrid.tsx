...
// Doc 5 Screen 1 Team Visual
// Role cards from Engineering Department DNA — ID badge, title, one-liner, hover expand
        ...
        {MEMBERS.map(m => {
          ...
          return (
            <div
              ...
              style={{
                background: isHovered ? 'rgba(140,0,180,0.08)' : 'rgba(255,255,255,0.03)',
                border: isHovered ? '1px solid rgba(140,0,180,0.4)' : '1px solid rgba(255,255,255,0.06)',
                borderRadius: '10px',
                padding: '20px',
                cursor: 'default',
