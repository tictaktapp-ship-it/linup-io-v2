...
async function hasArtifactBeenPaid(userId, projectId, artifactType) {
...
async function getDownloadAccess(userId, projectId, artifactType) {
...
async function generateSignedUrl(bucket, path) {
...
// Route registration
// ----------------------------------------------------------------
export async function downloadsRoutes(app) {
