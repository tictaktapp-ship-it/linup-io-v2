...
// Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ runIc (Doc 7A Ã¢â‚¬â€ IC execution with retry, max 3 iterations) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
async function runIc(memberId: string, projectId: string, stage: number, groupSummaries: GroupReviewSummary[], db: SupabaseClient): Promise<{ memberId: string; content: string }> {
  ...
  let iteration = 1;
  while (iteration <= 3) {
    await db.from('stage_runs').update({ current_ic_id: memberId, current_ic_iteration: iteration, updated_at: new Date().toISOString() }).eq('project_id', projectId).eq('stage', stage);
...
// Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ runStage (Doc 7A Ã¢â‚¬â€ main loop) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
export async function runStage(projectId: string, stage: number, db: SupabaseClient): Promise<void> {
  ...
  // 3. Execute IC groups sequentially (Doc 7A Ã¢â‚¬â€ never brief all ICs simultaneously)
  const allGroupSummaries: GroupReviewSummary[] = [];
  for (const group of vpAnalysis.executionSequence) {
    await db.from('stage_runs').update({ current_group_id: group.id, updated_at: new Date().toISOString() }).eq('project_id', projectId).eq('stage', stage);
  ...
  // CHECKPOINT 1
  await db.from('stage_runs').update({ checkpoint_1_reached: true, updated_at: new Date().toISOString() }).eq('project_id', projectId).eq('stage', stage);
  ...
  // CHECKPOINT 2
  await db.from('stage_runs').update({ checkpoint_2_reached: true, updated_at: new Date().toISOString() }).eq('project_id', projectId).eq('stage', stage);
  ...
  if (pltOutput.hasQuestions) {
    ...
    // No questions Ã¢â‚¬â€ compress immediately and proceed
